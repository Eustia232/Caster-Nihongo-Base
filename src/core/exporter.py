...
def generate_markdown(
    ...
    if classify_order:
        ...
        def parse_key(k: str):
            # keys are generated by classification_name as either "pos" or "pos / category".
            # Be tolerant: accept separators with or without spaces around '/'.
            if " / " in k:
...
def default_out_path() -> str:
    # Use Asia/Shanghai timezone for filename timestamps
